...
export default function HomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      {/* Hero Section - Full screen and mobile optimized */}
      <section className="container px-4 sm:px-6 flex flex-col items-center justify-center gap-6 min-h-[calc(100vh-4rem)] py-16 text-center relative overflow-hidden">
        {/* BG decorative elements for Hero */}
        <div className="absolute top-1/4 -left-12 w-64 h-64 bg-primary/5 rounded-full blur-3xl -z-10" />
        <div className="absolute bottom-1/4 -right-12 w-64 h-64 bg-accent-green/5 rounded-full blur-3xl -z-10" />
